<template>
  <div>
    ...
    <div>
      ...
      <pre class="language-vue" style="border: solid 1px grey"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
